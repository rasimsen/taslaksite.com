...
if (file_exists($settings)) {
	...
	if (file_exists($settingsdefault)) {
		...
		echo '<li class="bad">'.$settingsdefault.' does not exist, the server was unable to automatically rename it to settings.php.<br />Alternatively your server might not support automatic renaming of this file.</li>';
	}
}
...
if (file_exists($dbconnect)) {
	...
	if (file_exists($dbconnectdefault)) {
		...
		echo '<li class="bad">'.$dbconnectdefault.' does not exist, the server was unable to automatically rename it to dbconnect.php.<br />Alternatively your server might not support automatic renaming of this file.</li>';
	}
}
...
echo '</ul><h3>Checking Capable PHP and MySQL Features</h3>';
