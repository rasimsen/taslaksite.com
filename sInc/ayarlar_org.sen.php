<?php
	...
	if(WINDOWS){
		...
		define("sKOK_DIZIN","E:\\taslaksite.com\\");
		define("sURL","http://rs.web/taslaksite.com/");
		define("sGecici",sKOK_DIZIN."sSablonlar\\");

		define('sAYIRAC','\\');

	}else{

		define("sKOK_DIZIN","/home/rasimsen/taslaksite.com/");
		define("sURL","http://www.taslaksite.com/");
		define("sGecici",sKOK_DIZIN."sSablonlar/");
	...
	//cookie
	//define("ADMIN_COOKIE","admin_id");
	//define("UYE_COOKIE","uye_id");
	//define("LISTELENECEK_KAYIT_SAYISI",15);
