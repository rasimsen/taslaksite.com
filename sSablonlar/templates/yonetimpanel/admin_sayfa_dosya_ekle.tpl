...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table width="50%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr><td>1.Dosya</td><td><input type="file" name="DOSYA1" /></td><td><input type="text" name="KISA_ACIKLAMA1" maxlength="255" size="60"/></td></tr>
    <tr><td>2.Dosya</td><td><input type="file" name="DOSYA2" /></td><td><input type="text" name="KISA_ACIKLAMA2" maxlength="255" size="60"/></td></tr>
    <tr><td>3.Dosya</td><td><input type="file" name="DOSYA3" /></td><td><input type="text" name="KISA_ACIKLAMA3" maxlength="255" size="60"/></td></tr>
    <tr><td>4.Dosya</td><td><input type="file" name="DOSYA4" /></td><td><input type="text" name="KISA_ACIKLAMA4" maxlength="255" size="60"/></td></tr>
    ...
    <tr>
      <td><input type="submit" name="dosyaKaydet" value="Kaydet" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
