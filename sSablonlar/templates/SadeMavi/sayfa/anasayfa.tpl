  ...
  {strip}
		...
		<tr>
		  ...
		  <td class="baslik" align="left"><a href="index.php?id={$guncel_veri[i].ID}">{$guncel_veri[i].BASLIK}</a></td>
	        ...
	        <tr>
	          <td class="icerik" align="left" style="background-color:#FFF;">{$guncel_veri[i].KISA_OZET} <a href="index.php?id={$guncel_veri[i].ID}">( <img src="{$resim}kitap_16.png" border="0" align="middle"> devamý için týklayýnýz..)</a></td>
	        </tr>
		</table>
		</td></tr>
        <tr>
          <td class="icerik">
	          <table cellspacing="0" cellpadding="0" width="100%" class="tbl_icerik">
	          	<tr><td colspan="4" class="tbl_etiket"><b>Etiketler:</b> {$guncel_veri[i].ETIKET}</td></tr>
