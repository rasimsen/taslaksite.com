{include file="sayfa_ustu.tpl"}<table width="100%" height="*" border="0" cellspacing="0" cellpadding="0">
...
<table border="0" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr align="left"><td>Sayfa</td><td colspan=2><select name="sayfa" id="id_SAYFA_ADI" >{html_options options=$sayfalar selected=$sayfa_adi}</select></td></tr>
...
{include file="taslak_sayfa_standart_icerik_gosterme.tpl"}
