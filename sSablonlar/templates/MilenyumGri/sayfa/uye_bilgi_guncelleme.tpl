            ...
            <tr><td colspan="2" align="center">{$mesajTaslakSite}</td></tr>
              <form id="form1" name="form1" method="post" action=""  onsubmit="return formKontrol(this);">
                <tr>
                  ...
                  <td><input disabled="true" type="text" name="kullanici_adi" maxlength="16"  class="data" onfocus="javascript:this.className='data2'" onblur="javascript:this.className='data'" value="{$r.KULLANICI_ADI}"/></td>
                </tr>
                <tr>
                  <td class="label" align="right">Email*</td>
                  <td><input disabled="true" type="text" name="email1" maxlength="128" class="data" onfocus="javascript:this.className='data2'" onblur="javascript:this.className='data'" value="{$r.EMAIL}"/></td>
                </tr>
                <tr>
                  <td class="label">&nbsp;</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td class="label" align="right">Eðitiminiz*:{$r.EGITIM}</td>
                ...
                <tr>
                  <td class="label" align="right">Cinsiyetiniz*:{$r.CINSIYET}</td>
                ...
                <tr>
                  <td class="label" align="right">Doðum Tarihi*:{$r.DOGUM_TARIHI}</td>
...
{/literal}		  <td class="label" align=right>Þehir:{$r.SEHIR}</td>
                ...
                <tr>
                  <td class="label" align=right>Ülke:{$r.ULKE}</td>
                  <td><select name="ulke" onchange="objeTextDegeri(this,'ulke_adi')">
                  	  	<option value="" selected>-Seçiniz-</option>
                  	  	<option value="TR">Türkiye</option>
                  	  	<option value="">Diðer</option>
                  	  </select> <input type="hidden" name="ulke_adi" id="ulke_adi" value=""/>
