...
<h2>{$tKATEGORI_YENI_EKLENENLER}</h2>
<p>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  {strip}
		...
		<tr>
		  ...
		  <td class="baslik" align="left"><a href="index.php?id={$guncel_veri[i].ID}">{$guncel_veri[i].BASLIK}</a></td>
	        ...
	        <tr>
	          <td class="icerik" align="left">{$guncel_veri[i].KISA_OZET}</td>
	        </tr>
		</table>
		</td></tr>
        <tr>
          <td class="icerik">
	          <table cellspacing="0" cellpadding="3" width="100%" class="tbl_icerik">
	          	<tr><td colspan="3" class="tbl_etiket">Etiketler: {$guncel_veri[i].ETIKET}</td><td class="tbl_etiket" align="right"><a href="index.php?id={$guncel_veri[i].ID}"><img src="{$resim}kitap_16.png" border="0" align="middle" width="15px"  Title="Detay icin tiklayiniz"></a></td></tr>
