...
<font style="font-size:14px; font-weight:bold">Gündemi olusturan son basliklar</font>

<table width="100%" border="0" cellspacing="0" cellpadding="3">
  {section name=i loop=$guncel_veri}
  {strip}<tr><td><table cellpadding="0" cellspacing="1" width="100%" border="0" class="tbl_icerik">
        ...
        <tr><td class="detail_area_box">&nbsp;</td></tr>
{/strip}
{/section}
        <tr>
